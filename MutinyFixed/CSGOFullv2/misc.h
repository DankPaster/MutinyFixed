...
{
	NormalizeFloatr(angles.x);
	NormalizeFloatr(angles.y);
	NormalizeFloatr(angles.z);
}
inline void NormalizeAngle(float& angle)
{
	NormalizeFloatr(angle);
}
#if 0
...
{
	NormalizeFloatr(angle.x);
	NormalizeFloatr(angle.y);
	NormalizeFloatr(angle.z);
}
